    ...
    const session = await stripe.checkout.sessions.create({
        ...
        success_url:
            process.env.NODE_ENV === "development"
                ...
                : "https://uscreen-digital-ecommerce.vercel.app/payment/success",
        cancel_url:
            process.env.NODE_ENV === "development"
                ? "http://localhost:3000/payment/cancel"
                : "https://uscreen-digital-ecommerce.vercel.app/payment/cancel",
    });
    ...
    const accountLink = await stripe.accountLinks.create({
        ...
        refresh_url:
            process.env.NODE_ENV === "development"
                ...
                : `https://uscreen-digital-ecommerce.vercel.app/billing`,
        return_url:
            process.env.NODE_ENV === "development"
                ? `http://localhost:3000/return/${data?.connectedAccountId}`
                : `https://uscreen-digital-ecommerce.vercel.app/return/${data?.connectedAccountId}`,
